...
2. map-reduce directory contains job.properties & workflow.xml files

3. map-reduce/lib/ contains the testoozie.jar file

4. commands.txt consists of all the commands used to run the Hadoop/Oozie workflow
